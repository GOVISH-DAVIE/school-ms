...
<body>
	...
	<div class="sidebar">
      ...
      {{-- Library (Koha) --}}
      <li class="nav-links-li {{ request()->is('parent/library*') ? 'showMenu':'' }}">
        <div class="iocn-link">
          <a href="#">
            <div class="sidebar_icon">
        ...
        <ul class="sub-menu">
          <li><a class="{{ (request()->is('parent/library') && !request()->is('parent/library/catalog')) ? 'active' : '' }}" href="{{ route('parent.koha.library') }}"><span>{{ get_phrase("Children's Books") }}</span></a></li>
          <li><a class="{{ (request()->is('parent/library/catalog')) ? 'active' : '' }}" href="{{ route('parent.koha.catalog') }}"><span>{{ get_phrase('Catalog Search') }}</span></a></li>
        </ul>
      </li>
      ...
      <li class="nav-links-li {{ request()->is('parent/fee_manager*')  ? 'showMenu':'' }}">
        ...
        <ul class="sub-menu">
            <li>
              <a class="{{ (request()->is('parent/finance*')) ? 'active' : '' }}" href="{{ route('parent.finance.invoices') }}">
                <span>{{ get_phrase('Fees & Invoices') }}</span>
              </a>
            </li>
            <li>
