...
<body>
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
            ...
            {{-- Library (Koha) --}}
            <li class="nav-links-li {{ request()->is('teacher/library*') ? 'showMenu':'' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="{{ (request()->is('teacher/library/catalog')) ? 'active' : '' }}" href="{{ route('teacher.koha.catalog') }}"><span>{{ get_phrase('Catalog Search') }}</span></a></li>
                    <li><a class="{{ (request()->is('teacher/my-library')) ? 'active' : '' }}" href="{{ route('teacher.koha.mylibrary') }}"><span>{{ get_phrase('My Books') }}</span></a></li>
                </ul>
            </li>
          ...
          <li class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('attendence/list*') || request()->is('payment/list*') ? 'showMenu':'' }}">
            ...
            <li class="nav-links-li {{ request()->is('teacher/question-bank*') ? 'showMenu':'' }}">
                <div class="iocn-link">
                    <a class="{{ request()->is('teacher/question-bank*') ? 'active' : '' }}" href="{{ route('teacher.qbank') }}">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48"><path d="M12 1a11 11 0 1 0 11 11A11.013 11.013 0 0 0 12 1zm0 20a9 9 0 1 1 9-9 9.01 9.01 0 0 1-9 9zm1-5v2h-2v-2zm-.06-2h-1.9c0-3 3-2.75 3-4.5A1.5 1.5 0 0 0 10.5 8a1.62 1.62 0 0 0-1.6 1.5H7A3.5 3.5 0 0 1 10.5 6 3.5 3.5 0 0 1 14 9.5c0 2.25-3 2.5-1.06 4.5z"/></svg>
                        </div>
