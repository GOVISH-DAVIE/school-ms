        ...
        <ul class="nav-links">
            ...
            <li class="nav-links-li {{ request()->is('accountant/student_fee_manager*') || request()->is('accountant/offline_payment/pending*')|| request()->is('accountant/expense_category*') || request()->is('accountant/expenses*') ? 'showMenu':'' }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a class="{{ request()->is('admin/finance/project*') ? 'active' : '' }}" href="{{ route('admin.finance.projects') }}"><span>{{ get_phrase('School Projects') }}</span></a></li>
                    <li><a class="{{ request()->is('admin/finance/expenses*') ? 'active' : '' }}" href="{{ route('admin.finance.expenses') }}"><span>{{ get_phrase('Expenses') }}</span></a></li>
                    <li><a class="{{ request()->is('admin/finance/incomes*') ? 'active' : '' }}" href="{{ route('admin.finance.incomes') }}"><span>{{ get_phrase('Other Income') }}</span></a></li>
                    <li><a class="{{ (request()->is('admin/finance/payroll*') || request()->is('admin/finance/payslip*')) ? 'active' : '' }}" href="{{ route('admin.finance.payroll') }}"><span>{{ get_phrase('Payroll') }}</span></a></li>
                    <li><a class="{{ (request()->is('admin/finance/accounts*') || request()->is('admin/finance/transfer*')) ? 'active' : '' }}" href="{{ route('admin.finance.accounts') }}"><span>{{ get_phrase('Accounts & Transfers') }}</span></a></li>
