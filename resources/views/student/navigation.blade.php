...
<body>
	...
	<div class="sidebar">
      ...
      <li class="nav-links-li {{ request()->is('student/dashboard') ? 'showMenu':'' }}">
        <div class="iocn-link">
          ...
          <ul class="sub-menu">
              ...
              <li>
                  <a class="{{ (request()->is('student/transcript*')) ? 'active' : '' }}" href="{{ route('student.transcript') }}"><span>{{ get_phrase('Transcript') }}</span></a>
              </li>
          </ul>
      </li>
      ...
      <li class="nav-links-li {{ request()->is('student/finance*') ? 'showMenu':'' }}">
          <div class="iocn-link">
              <a class="{{ (request()->is('student/finance*')) ? 'active' : '' }}" href="{{ route('student.finance.invoices') }}">
                  <div class="sidebar_icon">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48"><path d="M19,2H5A3,3,0,0,0,2,5V19a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V5A3,3,0,0,0,19,2ZM7,6h6a1,1,0,0,1,0,2H7A1,1,0,0,1,7,6Zm10,12H7a1,1,0,0,1,0-2H17a1,1,0,0,1,0,2Zm0-4H7a1,1,0,0,1,0-2H17a1,1,0,0,1,0,2Z"/></svg>
                  </div>
                  <span class="link_name">{{ get_phrase('My fees & invoices') }}</span>
              </a>
          </div>
      </li>
